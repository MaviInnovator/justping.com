    ...
    <div class="leading-page py-4">
        ...
        <div class="team-container">
            <div class="team-member">
                <img src="{{ asset('justping-front/img/ceo.jpeg') }}" alt="Team Member">
                <h3>Syed Shahab Mujtaba</h3>
                <p>CEO & Founder</p>
                <div class="social-icons">
                    <a href="#"><img src="{{ asset('justping-front/img/twitter.png') }}"></a>
                    <a href="#"><img src="{{ asset('justping-front/img/linkedin.png') }}"></a>
