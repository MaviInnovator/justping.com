...
<div class="card shadow mb-4">
    <div class="card-body">
        <form action="{{ route('admin_subcategory_update',$subcategories->id) }}" method="post" enctype="multipart/form-data">
            @csrf
            <div class="row">
                <div class="col-md-4">
                    <div class="mb-3">
                        <label for="" class="form-label">{{ __('Selct Category') }}*</label>
                       <select id="iconSelect" name="category" class="form-select">
                            <option value="">{{ __('Select Category') }}</option>
                            @foreach($categories as $item)
                            <option value="{{ $item->id }}" @if($subcategories->cat_id==$item->id) selected @endif>{{ $item->name }}</option>
                            @endforeach
                        </select>
                        </div>
            </div>
            ...
            <div class="row">
                <div class="col-md-4">
                    <div class="mb-3">
                        ...
                        <input type="text" name="slug" class="form-control" value="{{ $subcategories->slug }}">
                    </div>
                </div>
            </div>
            <div class="row">
                <div class="col-md-4">
                    <div class="mb-3">
                        ...
                        <div><img src="{{ asset('uploads/'.$subcategories->icon) }}" alt="" class="w_100"></div>
                    </div>
                    <div class="mb-3">
            ...
            <div class="row">
                <div class="col-md-4">
                    <div class="mb-3">
                        ...
                        <div><img src="{{ asset('uploads/'.$subcategories->banner) }}" alt="" class="w_100"></div>
                    </div>
                    <div class="mb-3">
