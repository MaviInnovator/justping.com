...
Route::get('/license/{slug}', [FrontController::class, 'license'])->name('license');
...
Route::get('/busines-setup/{slug}', [FrontController::class, 'page'])->name('custom_page');
...
Route::middleware('admin')->prefix('admin')->group(function () {
    ...
    Route::get('/category/index',[AdminCategoryController::class,'index'])->name('admin_category_index');
    ...
    Route::get('/brand/index',[AdminBrandController::class,'index'])->name('admin_brand_index');
    Route::get('/brand/create',[AdminBrandController::class,'create'])->name('admin_brand_create');
    Route::post('/brand/store',[AdminBrandController::class,'store'])->name('admin_brand_store');
    Route::get('/brand/edit/{id}',[AdminBrandController::class,'edit'])->name('admin_brand_edit');
    Route::post('/brand/update/{id}',[AdminBrandController::class,'update'])->name('admin_brand_update');
    Route::get('/brand/destroy/{id}',[AdminBrandController::class,'destroy'])->name('admin_brand_destroy');
    
    Route::get('/brand/destroy-banner/{id}',[AdminBrandController::class,'destroy_banner'])->name('admin_brand_destroy_banner');
